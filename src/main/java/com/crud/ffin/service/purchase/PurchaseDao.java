...
public interface PurchaseDao {
    ...
    public List<Purchase> getCouponList(Search search,String userId)throws Exception; //쿠폰 리스트를 출력
    public List<Purchase> getCartList(Search search, int orderNo)throws Exception; //주문상세에 있는 정보 List?로 가져옴
    public List<Purchase> getOrderList(Search search, String truckId)throws Exception; //현재판매목록
