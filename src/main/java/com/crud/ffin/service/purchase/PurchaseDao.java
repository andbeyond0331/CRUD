...
public interface PurchaseDao {
    ...
    public List<Purchase> getCouponList(Search search,String userId)throws Exception; //이용자가 가지고 있는 쿠폰 리스트를 출력
    public List<Purchase> getCartList( int orderNo)throws Exception; //주문상세에 있는 정보 List?로 가져옴
    public List<Purchase> getOrderList(Search search, String truckId)throws Exception; //푸드트럭에 대한 현재판매목록
    ...
    public int getTotalPoint (String userId)throws Exception;//보유 총포인트 조회
